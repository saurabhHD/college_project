...
private $thumb_path;
	...
	function store()
	{
		...
		$this->query = "INSERT INTO products(type,title,language,price,city,board,course,thumb,seller_id,page,description)VALUES('$this->type','$this->title','$this->language','$this->price','$this->city','$this->board','$this->course','$this->thumb_path','$this->user_id','$this->page','$this->description')";
